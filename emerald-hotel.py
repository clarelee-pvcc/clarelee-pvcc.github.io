...
def open_out_file():        
    ...
    f.write('<body style = font-style: italic, background-image: url(wp-emerald.png);  font-family: Droid Serif; margin: auto;">\n') 
...
def create_output_html():
    ...
    f.write("Grand Total: " + format(grandtotal, currency) + endtr)
