# Name: Clare Lee   
# Program Purpose: This program uses lists to find the personal
# property tax for vehicles in Charlottesville and produces a report which displays
# all data and the total tax due # for six months
#
...
def display_results():
    ...
    for i in range(num_vehicles):
        datalinel = owner_name[1]+ tab + vehicle[i] + tab + format(vehicle_value[i],moneyf) + tab
